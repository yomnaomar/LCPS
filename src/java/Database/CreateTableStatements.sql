...
INSERT INTO Comment(patientID, doctorID, comment, dateAdded, isVisible) VALUES(2, 1, 'Low-risk, but still needs to stop smoking', '2017-03-28', 1);
INSERT INTO Comment(patientID, doctorID, comment, dateAdded, isVisible) VALUES(2, 1, 'If smoking does not stop, he may develop several types of cancers', '2017-03-28', 0);
INSERT INTO Comment(patientID, doctorID, comment, dateAdded, isVisible) VALUES(3, 1, 'No worry at all! Good health :)', '2017-03-25', 1);

CREATE TABLE Gene
(
geneID INT PRIMARY KEY IDENTITY (1,1),
patientID INT,
doctorID INT,
name VARCHAR(140),
result VARCHAR(1000),
...
INSERT INTO Gene(patientID, doctorID, name, result, isFatal) VALUES(2, 1, 'Gene 1', 'This gene is a direct correspondent to lung cancer, better watch out', 1);
INSERT INTO Gene(patientID, doctorID, name, result, isFatal) VALUES(3, 1, 'Gene 1', 'Not present', 0);
INSERT INTO Gene(patientID, doctorID, name, result, isFatal) VALUES(3, 1, 'Gene 2', 'Must take care a little', 1);